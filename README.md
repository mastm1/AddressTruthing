...
10) 'python importFPARSImages.py -d images/A3/ -s A3.sqlite3' (creates a backend sqlite3 db using the sample images)
11) 'python mainFPARS.py -s A3.sqlite3' (executes the "truther", try it out)
...
13) 'python MatchWithPostalDatabase.py -s A3.sqlite3' (Performs USPS lookup of the OCR results and gives 11 digit ZIP, if successful)
